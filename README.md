...
| `/quiz` | Dojo Quiz — Japanese terminology by belt level, plus Kumite 1–12 sequence training. A React island, and the last page of the migration; `public/quiz.html` is gone and `/quiz.html` redirects here |
